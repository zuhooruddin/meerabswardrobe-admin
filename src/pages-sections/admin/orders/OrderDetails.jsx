    ...
    <Grid container spacing={3}>
      <Grid item xs={12}>
        ...
        >
          ...
          {orderDetail['customeronlinepaymentinvoice'] && orderDetail['customeronlinepaymentinvoice']?<Paragraph>
              <Span color="grey.600">Invoice No:</Span> <b>{orderDetail['customeronlinepaymentinvoice']}</b>
            </Paragraph>
            :''}
                      {orderDetail['paymentid'] && orderDetail['paymentid']?<Paragraph>

           
              <Span color="grey.600">Payment Time:</Span> <b>{orderDetail['paymenttime']}</b>
            </Paragraph> :'' 
      ...
      <Grid item md={6} xs={12}>
        ...
        >
          ...
          <FlexBetween mb={2}>
            ...
            <H6>{orderDetail['paymentMethod']}</H6>
          </FlexBetween>
          <FlexBetween mb={2}>
            <H6>Payment Status</H6>
            {orderDetail['paymentstatus']==='paid'?<H6 style={{color:'green', fontWeight: 'bold' }}>{orderDetail['paymentstatus']}</H6>:<H6 style={{color:'red', fontWeight: 'bold' }}>{orderDetail['paymentstatus']}</H6>}
          </FlexBetween>
